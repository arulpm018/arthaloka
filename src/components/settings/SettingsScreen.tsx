...
export type SettingsModule = "finance" | "productivity";

/**
 * Layar Settings bersama untuk semua modul (Keuangan & Produktivitas).
 * Section global (profil, personalisasi couple, tema, tentang, logout)
 * tampil di semua modul; section keuangan (akun default, saldo, meme)
 * hanya saat module="finance".
 */
export function SettingsScreen({ module }: { module: SettingsModule }) {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-2xl space-y-6 p-4 pb-20 md:max-w-3xl md:p-6">
        ...
        {/* Preferensi — default account (khusus Keuangan) */}
        {isFinance && (
        ...
        {/* Privasi — switches (khusus Keuangan) */}
        {isFinance && (
