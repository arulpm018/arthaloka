...
export default function TogetherPage() {
  ...
  useEffect(() => {
    setDefaultOwner("shared");
    return () => setDefaultOwner(null);
  }, [setDefaultOwner]);

  const { accounts, isLoading: accountsLoading } = useAccounts("shared");
  const { income, expense, isLoading: summaryLoading } = useSummary(selectedMonth, "shared");
